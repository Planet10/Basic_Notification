...
public class NewMessageNotification {
    ...
    public static void notify(final Context context, final String exampleString, final int number) {
        ...
        final String title = "Basic Notifications from class";
        final String text = "sample text from class NewMessageNotification";
        ...
        final NotificationCompat.Builder builder = new NotificationCompat.Builder(context)
                ...
                .setSmallIcon(R.drawable.ic_action_stat_share)
                ...
                .setContentIntent(
                        PendingIntent.getActivity(
                                context,
                                0,
                                new Intent(Intent.ACTION_VIEW, Uri.parse("http://www.lipsum.com/")),
